...
- **Data hub (of-record facts)**: molecule profile ledger Fact|Value|Source|Open — `src/lib/dataHub/*`, `DataHubLedgerView`; derived charts/AI under “Derived assistive views (not of-record)”. See `docs/design/data-hub-presentation.md`
