...
- **Data hub (of-record facts)**: Fact|Value|Source|Open ledger on molecule / gene / disease / org — `src/lib/dataHub/*`, `DataHubLedgerView`; CSV/TSV export; source directory by coverage; derived charts/AI labeled non-of-record. See `docs/design/data-hub-presentation.md`
