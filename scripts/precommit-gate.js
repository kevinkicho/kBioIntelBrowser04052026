...
const PRODUCT_PATTERNS = [
  ...
  'lib/api/__tests__/opencitations.test',
  'lib/api/__tests__/ctd.test',
  'lib/api/__tests__/chemspider.test',
  'lib/api/__tests__/fda-drug-shortages.test',
  'lib/api/__tests__/biosamples.test',
  'lib/api/__tests__/purpleBookPatents.test',
  'lib/api/__tests__/healthCanadaDpd.test',
  'lib/api/__tests__/openFdaLabelSections.test',
  'lib/api/__tests__/massive.test',
  'lib/api/__tests__/purpleBookCache.test',
  'lib/api/__tests__/cmsHospitals.test',
  'lib/api/__tests__/emaMedicinesBulk.test',
  'lib/pubchem-hazards.test',
  'lib/wikipathways.test',
  'lib/iris.test',
  'lib/openfda.test',
  'lib/stitch.test',
  'lib/opencitations.test',
  'prideHonesty',
  'cpicHonesty',
  'clingenHonesty',
  'cathHonesty',
  ...
  'massBankHonesty',
  'stitchHonesty',
  'opencitationsHonesty',
  'ctdHonesty',
  'chemspiderHonesty',
  'drugShortagesHonesty',
  'bioSamplesHonesty',
  'purpleBookPatentsHonesty',
  'healthCanadaDpdHonesty',
  'openFdaLabelsHonesty',
  'massiveHonesty',
  'purpleBookHonesty',
  'cmsHospitalsHonesty',
  'emaBulkHonesty',
