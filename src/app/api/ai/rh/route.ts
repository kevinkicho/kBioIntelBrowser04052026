  ...
  try {
    ...
    try {
      ...
      return NextResponse.json({
        ...
        mode,
        refused: true,
        refuseReason: err instanceof Error ? err.message : 'Invalid RH context',
      })
    }
    ...
    return NextResponse.json(
      {
        ok: false,
        refused: true,
        refuseReason: err instanceof Error ? err.message : 'RH AI unexpected error',
      },
      { status: 200 },
    )
  }
