...
export default function InteractionsError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[InteractionsError]', error)
  }, [error])
  ...
  return (
    <div className="min-h-screen bg-[#0f1117] flex items-center justify-center">
      <div className="max-w-md text-center space-y-4 p-8">
        ...
        <h1 className="text-xl font-bold text-red-400">Interaction checker error</h1>
