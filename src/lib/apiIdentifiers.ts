...
/**
 * Prefer structure-stable identifiers where the free API supports them.
 * gene_symbol / uniprot_accession never silently use chemical names (see resolveApiQuery).
 */
export const API_IDENTIFIER_CONFIGS: ApiIdentifierConfig[] = [
  { panelId: 'chembl', label: 'ChEMBL', defaultType: 'inchikey', supportedTypes: ['name', 'smiles', 'inchikey'] },
  { panelId: 'chembl-mechanisms', label: 'ChEMBL Mechanisms', defaultType: 'inchikey', supportedTypes: ['name', 'smiles', 'inchikey'] },
  ...
  { panelId: 'toxcast', label: 'EPA ToxCast', defaultType: 'cas', supportedTypes: ['name', 'cas'] },
  { panelId: 'sider', label: 'SIDER', defaultType: 'name', supportedTypes: ['name'] },
  { panelId: 'iris', label: 'EPA IRIS', defaultType: 'cas', supportedTypes: ['name', 'cas'] },
  { panelId: 'comptox', label: 'EPA CompTox', defaultType: 'inchikey', supportedTypes: ['name', 'cas', 'inchikey'] },
  { panelId: 'gwas-catalog', label: 'GWAS Catalog', defaultType: 'gene_symbol', supportedTypes: ['name', 'gene_symbol'] },
  { panelId: 'clinvar', label: 'ClinVar', defaultType: 'gene_symbol', supportedTypes: ['name', 'gene_symbol'] },
  { panelId: 'uniprot', label: 'UniProt', defaultType: 'uniprot_accession', supportedTypes: ['name', 'gene_symbol', 'uniprot_accession'] },
  { panelId: 'uniprot-extended', label: 'UniProt Extended', defaultType: 'uniprot_accession', supportedTypes: ['name', 'gene_symbol', 'uniprot_accession'] },
  { panelId: 'pdb', label: 'RCSB PDB', defaultType: 'name', supportedTypes: ['name', 'pdb_id'] },
  { panelId: 'alphafold', label: 'AlphaFold', defaultType: 'uniprot_accession', supportedTypes: ['gene_symbol', 'uniprot_accession'] },
  ...
  { panelId: 'string', label: 'STRING', defaultType: 'gene_symbol', supportedTypes: ['name', 'gene_symbol'] },
  { panelId: 'stitch', label: 'STITCH', defaultType: 'cid', supportedTypes: ['name', 'cid'] },
  ...
  { panelId: 'omim', label: 'OMIM', defaultType: 'gene_symbol', supportedTypes: ['name', 'gene_symbol'] },
