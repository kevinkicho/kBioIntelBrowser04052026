...
const categoryMappings: { category: string; panels: PanelMapping[] }[] = [
  {
    ...
    panels: [
      ...
      { propKey: 'purpleBookPatents', title: 'Purple Book patents (BPPT)' },
      { propKey: 'emaBulkMedicines', title: 'EMA medicines dump' },
      { propKey: 'establishmentLinks', title: 'Manufacturing / establishments' },
  ...
  },
  {
    ...
    panels: [
      ...
      { propKey: 'euResearchOrgs', title: 'EU research organizations (ROR)' },
      { propKey: 'usColleges', title: 'US colleges (Scorecard)' },
