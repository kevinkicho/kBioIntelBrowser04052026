 ...
 *
 * Pure data: no network. Used by /how-it-works (Tools tab), playbook tips,
 * and `export:research-catalog` → researchPlaybooks.json for zero-dep CLI.
 *
 * Product law: free public APIs; deterministic Discover rank; AI claim-bound only.
 *
 * Module: src/lib/methods/research/catalog.ts (public: researchToolCatalog.ts)
 */
