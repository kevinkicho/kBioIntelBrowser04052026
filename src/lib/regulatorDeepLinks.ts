...
export function buildInternationalRegulatorLinks(moleculeName: string): RegulatorDeepLink[] {
  ...
  return [
    ...
    },
    {
      ...
      region: 'US',
      description: 'Licensed biological products, biosimilars, and interchangeability (portal)',
      url: 'https://purplebooksearch.fda.gov/',
      kind: 'portal',
    },
    {
      id: 'purple-book-download',
      label: 'Purple Book data downloads',
      region: 'US',
      description: 'Official monthly Purple Book report downloads (Excel/CSV)',
      url: 'https://purplebooksearch.fda.gov/downloads',
      kind: 'download',
    },
    {
      id: 'fda-establishment',
      label: 'FDA establishment / FEI dashboard',
      region: 'US',
      description: 'Inspected facilities (manufacturing plants) — search by firm name',
      url: `https://datadashboard.fda.gov/ora/cd/index.htm`,
      kind: 'portal',
    },
    {
      id: 'un-comtrade',
      ...
      region: 'Global',
      description: 'Merchandise trade by HS code (not INN-level) — public portal',
    ...
    },
    {
      ...
      label: 'USITC DataWeb',
      region: 'US',
      description: 'US import/export statistics by tariff line (HS) — public portal',
