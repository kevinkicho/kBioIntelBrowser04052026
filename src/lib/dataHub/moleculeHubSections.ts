/**
 * Molecule data-hub section builders (modularized for maintainability).
 * Pure; no network. Orchestrated by buildMoleculeDataHub.ts.
 */
...
export function buildMoleculeHubParts(
  ...
  // Append into clinical section
  all.push(trialTitleRow, trialEnrollRow)
