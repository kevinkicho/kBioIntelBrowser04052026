...
const API_CATEGORY_MAP: Record<string, { id: string; label: string; icon: string }> = {
  ...
  'ror-eu-pack': { id: 'research-literature', label: 'Research & Literature', icon: '📚' },
  'scorecard-grants': { id: 'research-literature', label: 'Research & Literature', icon: '📚' },
  'scorecard-query': { id: 'research-literature', label: 'Research & Literature', icon: '📚' },
  'college-scorecard': { id: 'research-literature', label: 'Research & Literature', icon: '📚' },
