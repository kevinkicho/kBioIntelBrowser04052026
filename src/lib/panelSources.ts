...
const ENTRIES: Record<string, PanelSourceEntry> = {
  ...
  'nci-cadsr': { source: 'NCI EVS (NIH)', api: 'NCI EVS REST (NCIt)', description: 'NCI Thesaurus concepts (free public EVS; caDSR host deprecated)', docs: 'https://api-evsrest.nci.nih.gov/', endpoint: 'https://api-evsrest.nci.nih.gov/api/v1/concept/ncit/search', _metaKey: 'nci-cadsr' },
