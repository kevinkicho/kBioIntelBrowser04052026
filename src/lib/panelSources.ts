...
const ENTRIES: Record<string, PanelSourceEntry> = {
  ...
  'drugs-fda': {
    source: 'U.S. FDA',
    api: 'openFDA Drugs@FDA',
    description: 'NDA/ANDA/BLA applications and products from free openFDA Drugs@FDA',
  ...
  'openfda-labels': {
    source: 'U.S. FDA',
    api: 'openFDA drug/label',
    description: 'Structured SPL sections (boxed warning, AE, interactions) via free openFDA',
    docs: 'https://open.fda.gov/apis/drug/label/',
    endpoint: 'https://api.fda.gov/drug/label.json',
    _metaKey: 'openfda-labels',
  },
  ...
  'chembl-indications': { source: 'EMBL-EBI', api: 'ChEMBL Indications', description: 'ChEMBL drug indications data', docs: 'https://www.ebi.ac.uk/chembl/', endpoint: 'https://www.ebi.ac.uk/chembl/api/data', _metaKey: 'chembl-indications' },
  ...
  'sider': { source: 'openFDA FAERS (SIDER-compatible)', api: 'openFDA Drug Event', description: 'Side-effect reaction labels from openFDA FAERS (SIDER dumps are not free JSON; panel is SIDER-compatible)', docs: 'https://open.fda.gov/apis/drug/event/', endpoint: 'https://api.fda.gov/drug/event.json', _metaKey: 'sider' },
  'iris': { source: 'EPA / PubChem', api: 'IRIS (PubChem)', description: 'EPA IRIS RfD/RfC and critical effects via PubChem; CompTox for DTXSID identity', docs: 'https://www.epa.gov/iris', endpoint: 'https://pubchem.ncbi.nlm.nih.gov/rest/pug_view', _metaKey: 'iris' },
  ...
  'foodb': { source: 'Univ. of Alberta', api: 'FooDB', description: 'FooDB food constituents (free public substitute for DFDB/PhytoHub)', docs: 'https://foodb.ca/', endpoint: 'https://foodb.ca/api', _metaKey: 'foodb' },
  'chembl': { source: 'EMBL-EBI', api: 'ChEMBL', description: 'ChEMBL bioactivity database for drug discovery', docs: 'https://www.ebi.ac.uk/chembl/', endpoint: 'https://www.ebi.ac.uk/chembl/api/data', _metaKey: 'chembl' },
  ...
  'chembl-mechanisms': { source: 'EMBL-EBI', api: 'ChEMBL Mechanisms', description: 'ChEMBL mechanism of action data for drugs', docs: 'https://www.ebi.ac.uk/chembl/', endpoint: 'https://www.ebi.ac.uk/chembl/api/data/mechanism', _metaKey: 'chembl-mechanisms' },
  ...
  'ttd': { source: 'TTD via BioThings/NCATS', api: 'BioThings TTD KP', description: 'Therapeutic Target Database associations (free BioThings KP)', docs: 'https://db.idrblab.net/ttd/', endpoint: 'https://biothings.ncats.io/ttd', _metaKey: 'ttd' },
  ...
  'nci-cadsr': { source: 'NCI EVS (NIH)', api: 'NCI EVS/NCIt', description: 'NCI Thesaurus concepts via free public EVS REST (replaces retired caDSR host)', docs: 'https://api-evsrest.nci.nih.gov/', endpoint: 'https://api-evsrest.nci.nih.gov/api/v1/concept/ncit/search', _metaKey: 'nci-cadsr' },
  ...
  'niaid-immport': { source: 'NIAID (NIH)', api: 'ImmPort Shared Data Search', description: 'ImmPort immunology studies (free public search API)', docs: 'https://docs.immport.org/apidocumentation/shareddataapi/search/', endpoint: 'https://www.immport.org/data/query/api/search/study', _metaKey: 'niaid-immport' },
  ...
  'nsf-awards': {
    source: 'U.S. NSF',
    api: 'NSF Awards Search',
    description: 'National Science Foundation awards by keyword (PI, org, abstract)',
    docs: 'https://www.research.gov/common/webapi/awardapisearch-v1.htm',
    endpoint: 'https://api.nsf.gov/services/v2/awards.json',
    _metaKey: 'nsf-awards',
  },
