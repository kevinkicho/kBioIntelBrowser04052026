...
import { MetricTip } from '@/components/ui/HelperTip'
import {
  emptyDataClass,
  isEmptyMetric,
  summaryCardHasData,
                  ...
                  >
                    {metric.panelId ? (
                      <button
                        ...
                        className="group flex items-center gap-1.5 hover:text-indigo-300 transition-colors w-full text-left"
                      >
                        <MetricTip
                          value={
                          ...
                          label={metric.label}
                          detail={`${metric.label}: ${metric.value}. Open panel for full table.`}
                          testId={`summary-metric-tip-${card.id}-${metric.label}`}
                        />
                      ...
                      <MetricTip
                        ...
                        label={metric.label}
                        detail={`${metric.label}: ${metric.value}`}
                      />
                    )}
                  </div>
                )
