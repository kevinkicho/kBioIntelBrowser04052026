...
export const ReactomePanel = memo(function ReactomePanel({ pathways, moleculeName, panelId, lastFetched }: Props) {
  ...
  if (pathways.length === 0) {
    return (
      <Panel title="Reactome Pathways" panelId={panelId} lastFetched={lastFetched}>
        <p className="text-slate-500 text-sm">No Reactome pathways found for this molecule.</p>
      </Panel>
    )
  }
