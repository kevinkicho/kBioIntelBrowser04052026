  ...
  return (
    ...
    >
      <div className="mb-2 flex flex-wrap items-center gap-1.5">
        ...
        <HelperTip
          content="One-click playbooks that combine free-API tools for scientific work. Of-record Discover rank stays deterministic; AI is claim-bound and non-of-record."
          ...
          >
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              ...
              {tip.actionHref && tip.actionLabel && (
                <Link
                  href={tip.actionHref}
                  className="rounded border border-emerald-800/40 bg-emerald-950/20 px-2 py-0.5 text-[10px] text-emerald-300/90 hover:bg-emerald-900/30"
